...
<head>
    ...
    <title>Archivio Lettere Maestra Fausta - Associazione Pamoya Onlus</title>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="fausta.php">Lettere Maestra Fausta</a></li>
                    <li><a href="archivio_tarcisio.php">Archivio Don Tarcisio</a></li>
                    <li role="presentation" class="active"><a href="#">Archivio Maestra Fausta</a></li>
                </ul>
                <!-- Page Heading -->
                <div class="row">
                    <div class="col-lg-12">
